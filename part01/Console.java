...
public class Console {
	...
	public static void main(String[] args) {
		...
		AudioTrack trk1 = new AudioTrack("Listen to the Music", "The Doobie Brothers", 4, Genre.ROCK, "mp3");
		AudioTrack trk2 = new AudioTrack("Follow God", "Kanye West", 3, Genre.OTHER, "wav");
		AudioTrack trk3 = new AudioTrack("Show Me Love", "Steve Angello", 2, Genre.DANCE, "mp3");
		AudioTrack trk4 = new AudioTrack("Sultans Of Swing", "Dire Straits", 4, Genre.ROCK, "wav");
		AudioTrack trk5 = new AudioTrack("Physical", "Dua Lipa", 3, Genre.POP, "mp3");
		AudioTrack trk6 = new AudioTrack("Turn Up The Radio", "OK go!", 3, Genre.POP, "wav");
		AudioTrack trk7 = new AudioTrack("Once Upon a Time in the West", "Dire Straits", 5, Genre.ROCK, "wav");
